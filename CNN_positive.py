...
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/ghosting-artifact-metric/Project/Models/CNN_POSITIVE_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/ghosting-artifact-metric/Project/Models/CNN_POSITIVE_CW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/ghosting-artifact-metric/Project/Models/CNN_POSITIVE_CB.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
eval (cnn_wcw_model, X_test, y_test, model_name = "CNN", feature_name = "Positive Difference Map", technique = "Baseline")
eval (cnn_cw_model, X_test, y_test, model_name = "CNN", feature_name = "Positive Difference Map", technique = "Class Weight")
eval (cnn_cb_model, X_test, y_test, model_name = "CNN", feature_name = "Positive Difference Map", technique = "Class Balance")
