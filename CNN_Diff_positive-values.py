...
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/Code/Models/CNN_Diff_wCW_POSITIVE.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Code/Models/CNN_Diff_CW_POSITIVE.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/Code/Plots/CNN_Diff_CW_POSITIVE_precision_recall_curve.png'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/Code/Plots/CNN_Diff_CB_POSITIVE_precision_recall_curve.png'
...
misclass_En_csv_path = '/Code/Results/Precision_Ensemble_CNN_Diff_POSITIVE_misclassified_patches.csv'
...
misclass_En_csv_path = '/Code/Results/Average_Ensemble_CNN_Diff_POSITIVE_misclassified_patches.csv'
misclassified_indexes = np.where(predicted_classes != true_labels)[0]
