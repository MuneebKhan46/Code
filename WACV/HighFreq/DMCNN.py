...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), os.path.join(model_dir, 'HighFreq_DMCNN_model.pth'))
...
model.load_state_dict(torch.load(os.path.join(model_dir, 'HighFreq_DMCNN_model.pth')))
model.eval()
...
image_save_dir = os.path.join(Results_dir, 'images/DM-CNN_High/')
...
results.append({'Model': 'DMCNN', 'Artifact Type': 'High Freq', 'PSNR': avg_psnr, 'SSIM': avg_ssim})
