...
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/Code/Models/DNN_Diff_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Code/Models/DNN_Diff_CW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Code/Models/DNN_Diff_CB.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
plt.grid(True)
precision_recall_curve_path = '/Code/Plots/DNN_Diff_wCW_precision_recall_curve.png'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/Code/Plots/DNN_Diff_CW_precision_recall_curve.png'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/Code/Plots/DNN_Diff_CB_precision_recall_curve.png'
...
misclass_En_csv_path = '/Code/Results/Precision_Ensemble_DNN_Diff_misclassified_patches.csv'
...
misclass_En_csv_path = '/Code/Results/Average_Ensemble_DNN_Diff_misclassified_patches.csv'
misclassified_indexes = np.where(predicted_classes != true_labels)[0]
