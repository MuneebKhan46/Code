...
cw_history = cnn_cw_model.fit(X_train, y_train, epochs=5, class_weight=class_weight, validation_data=(X_val, y_val))
...
cb_history = cnn_cb_model.fit(cb_train_patches, cb_train_labels, epochs=5, class_weight=class_weight, validation_data=(X_val, y_val))
