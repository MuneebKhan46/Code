...
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/Project/Models/CNN_Y_CHANNEL_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Project/Models/CNN_Y_CHANNEL_CW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Project/Models/CNN_Y_CHANNEL_CB.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
